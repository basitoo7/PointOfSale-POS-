      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":047C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":08D0
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":0D24
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":1178
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":15CC
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":1A20
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSMGroups.frx":2174
               Key             =   ""
            EndProperty
         EndProperty
      End
...
gc_dbcon.BeginTrans
     Select Case Mode
           Case "A"
              cntsql.CommandText = "INSERT INTO Sys_Groups(GROUPCODE, GROUPDESC, ADDDATETIME) VALUES (" & Val(txtGroupCode) & ",'" & UCase(RepApp(Trim(txtGroupDesc))) & "','" & Format(Now, "YYYY/MM/DD hh:mm:ss") & "')"
              cntsql.Execute
              txtGroupCode = SerMaxNo(gc_dbcon, "Sys_Groups", "GroupCode")
           Case "E"
...
Public Function ChkInputs() As Boolean
    If Len(Trim(txtGroupCode.Text)) > 0 And Len(RTrim(txtGroupDesc)) > 0 Then
       ChkInputs = True
    Else
