...
Begin VB.Form frmPLSheet3 
   Caption         =   "Profit and Loss SubNotes Setup"
   ClientHeight    =   4965
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5280
   Icon            =   "frmPLSheet3.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":08D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":0D26
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":117A
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":15CE
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":1A22
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":1E76
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet3.frx":25CA
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Dim PR_GlPL02 As Recordset
Dim PR_GlPL03 As Recordset
...
Private Sub cmdLookup_Click()
    ...
    Set PO_DESC = Text1
    GoTop PR_GlPL03
    PR_GlPL03.Filter = "Plcode = '" & txtbcode & "' and PLNCODE = '" & txtbncode & "' "
    
    MyLookup.Caption = "Profit and loss Sub Notes"
    MyLookup.FillGrid PR_GlPL03, "PLNICODE", "PLNIdesc", 5
    MyLookup.Show 1
    PR_GlPL03.Filter = adFilterNone
    If Len(txtbnscode) > 0 Then
...
Private Sub cmdLookup0_Click()
    ...
    GoTop PR_GlPL01
    MyLookup.Caption = "Profit and Loss Main Head"
    MyLookup.FillGrid PR_GlPL01, "Plcode", "PLDESC", 5
    MyLookup.Show 1
...
Private Sub cmdLookup1_Click()
    ...
    PR_GlPL02.Filter = "Plcode = '" & txtbcode & "'"
    GoTop PR_GlPL02
    MyLookup.Caption = "Profit and Loss Sheet Notes"
    MyLookup.FillGrid PR_GlPL02, "PLNCODE", "PlnDESC", 5
    MyLookup.Show 1
    PR_GlPL02.Filter = adFilterNone
...
Private Sub Form_Load()
  ...
  Set PR_GlPL02 = New Recordset
  Set PR_GlPL03 = New Recordset

  PR_GlPL01.Open "Select GL_PlSheet1.* from GL_PlSheet1 where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
  PR_GlPL02.Open "Select GL_PlSheet2.* from GL_PlSheet2 where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
  PR_GlPL03.Open "Select GL_PlSheet3.* from GL_PlSheet3 where compcode = '" & Gs_compcode & "' ", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
   
  PB_BlnkGls0 = IIf(PR_GlPL02.EOF, True, False)
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If PB_BlnkGls0 And Range(Button.Index, 2, 3) Then
       ...
       'Cancel = True
    Else
       Mode = DentMode(Mode, Button.Index, PR_GlPL03, Me, txtbcode, txtbdesc, "X", "CompCount", 3, "Acct_sub0", "Acct_Desc", 1, False, Toolbar1)
        If Mode = "A" Then
...
gc_dbcon.BeginTrans
    ...
    If Mode = "A" Then
                pr_dumy.Open "select max(PLNICODE) as PLNCODE from GL_PlSheet3 where Plcode = '" & txtbcode.Text & "' and PLNCODE = '" & txtbncode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
                If Not pr_dumy.EOF Then
                    txtbnscode = DoPad(Trim(str(Val(0 & pr_dumy("PLNCODE")) + 1)), txtbnscode.MaxLength)
                Else
    ...
    End If
     ...
     Select Case Mode
           Case "D"
                 gc_dbcon.Execute "DELETE FROM GL_PlSheet3 WHERE Plcode = '" & txtbcode & "' AND PLNCODE = '" & txtbncode & "' AND PLNICODE = '" & txtbnscode & "' and compcode = '" & Gs_compcode & "'"
                 gc_dbcon.Execute "DELETE FROM GL_PlSheet3DETAIL WHERE Plcode = '" & txtbcode & "' AND PLNCODE = '" & txtbncode & "' AND PLNICODE = '" & txtbnscode & "' and compcode = '" & Gs_compcode & "'"
           ...
           Case Else
                ...
                gc_dbcon.Execute "INSERT INTO  GL_PlSheet3 (Compcode,Plcode, PLNCODE, PLNICODE,PLNIdesc) VALUES('" & Gs_compcode & "','" & txtbcode & "','" & txtbncode & "','" & txtbnscode & "','" & txtbnsdesc & "')"
                
                
                With grdVoucher
                       For ln_cnt = 1 To .Rows - 1
                          If Len(Trim(.TextMatrix(ln_cnt, 1))) > 0 Then
                           gc_dbcon.Execute "INSERT INTO  GL_PlSheet3DETAIL (Compcode,Plcode, PLNCODE, PLNICODE,accountno) VALUES('" & Gs_compcode & "','" & txtbcode & "','" & txtbncode & "','" & txtbnscode & "','" & .TextMatrix(ln_cnt, 1) & "')"
                          End If
                       Next
                End With
...
Sub SetVal()
    txtdesc = Trim(PR_GlPL03("PLNICODE"))
    Call LoadTrans
End Sub
Private Sub LoadTrans()
Call InitializeGrid
 pr_dumy.Open "Select * from  GL_PlSheet3DETAIL where Plcode = '" & txtbcode & "' and  PLNCODE = '" & txtbncode & "' and  PLNICODE = '" & txtbnscode & "' and  CompCode = '" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
    If Not pr_dumy.EOF Then
        With grdVoucher
...
Dim lb_found As Boolean
    ...
    If Trim(txtbnscode) <> "" And Mode <> "A" Then
        ...
        PR_GlPL03.Filter = "Plcode = '" & txtbcode & "' and PLNCODE = '" & txtbncode & "'"
        lb_found = MySeek(txtbnscode, "PLNICODE", PR_GlPL03)
...
Dim lb_found As Boolean
    ...
    If Trim(txtbcode) <> "" Then
        ...
        lb_found = MySeek(txtbcode.Text, "Plcode", PR_GlPL01)
       
        If Not lb_found Then
            Call SetErr(Gs_RecNFMsg, vbCritical)
            'Cancel = True
        Else
            txtbdesc = PR_GlPL01("PLDESC")
            'txtPLNCODE.SetFocus
...
Dim lb_found As Boolean
    ...
    If Trim(txtbncode) <> "" Then
     ...
     PR_GlPL02.Filter = "Plcode = '" & txtbcode & "'"
        lb_found = MySeek(txtbncode.Text, "PLNCODE", PR_GlPL02)
        ...
        Else
            If Mode = "A" Then
                pr_dumy.Open "select max(PLNICODE) as PLNCODE from GL_PlSheet3 where Plcode = '" & txtbcode.Text & "' and PLNCODE = '" & txtbncode & "' and compcode = '" & Gs_compcode & "' ", gc_dbcon, adOpenStatic, adLockReadOnly, 1
                If Not pr_dumy.EOF Then
                    txtbnscode = DoPad(Trim(str(Val(0 & pr_dumy("PLNCODE")) + 1)), txtbnscode.MaxLength)
                Else
                    txtbnscode = DoPad(Trim(str(1)), txtbnscode.MaxLength)
