...
Begin VB.Form frmPLSheet1 
   Caption         =   "Profit and Loss Main Heads Setup "
   ClientHeight    =   1635
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4965
   Icon            =   "frmPLSheet1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":047C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":08D0
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":0D24
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":1178
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":15CC
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":1A20
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPLSheet1.frx":2174
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    ElseIf KeyCode = vbKeyF11 Then
        Mode = DentMode(Mode, 4, PR_GlPL01, Me, txtsub0, txtdesc, "X", "CompCount", 3, "Acct_sub0", "Acct_Desc", 1, False, Toolbar1)
    End If
End Sub
...
Private Sub Form_Load()
    ...
    PB_BlnkGls0 = IIf(PR_GlPL01.EOF, True, False)
...
gc_dbcon.BeginTrans
     Select Case Mode
           Case "A"
              gc_dbcon.Execute "INSERT INTO GL_PlSheet1(CompCode,PLCODE, PLDESC) VALUES ('" & Gs_compcode & "', '" & RepApp(Trim(txtsub0.Text)) & "','" & UCase(RepApp(Trim(txtdesc.Text))) & "')"
              
           Case "E"
              gc_dbcon.Execute "UPDATE GL_PlSheet1 SET PLDESC = '" & UCase(RepApp(txtdesc.Text)) & "' WHERE PLCODE = '" & RepApp(txtsub0.Text) & "' and compcode = '" & Gs_compcode & "'"
              
           Case "D"
              gc_dbcon.Execute "DELETE FROM GL_PlSheet1 WHERE PLCODE = '" & RepApp(txtsub0.Text) & "' and compcode = '" & Gs_compcode & "'"
