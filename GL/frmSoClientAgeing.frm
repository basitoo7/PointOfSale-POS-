...
Begin VB.Form frmSoClientAging 
   Caption         =   "Account Receiable Ageing "
   ClientHeight    =   3765
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5835
   ...
   EndProperty
   Icon            =   "frmSoClientAgeing.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.CommandButton Command5 
               Height          =   315
               Left            =   2685
               Picture         =   "frmSoClientAgeing.frx":030A
               Style           =   1  'Graphical
               TabIndex        =   18
               TabStop         =   0   'False
               Top             =   180
   ...
   End
End
Attribute VB_Name = "frmSoClientAging"
...
MDIForm1.StatusBar1.Panels(7).Text = "Processing Data Please Wait..."
    With crrpt
        ...
        .SelectionFormula = ""
        .ReportFileName = App.Path & Gs_GlRepoPath & "\ClientAgeingReportsum.RPT"
...
'        .Formulas(17) = "day5 = " & Val(Txtday41) & ""
          ...
          ls_sql = "SELECT Gl_Trans.accountno, round(SUM(Gl_Trans.Dr_Amount),0) AS Amount1, 0 AS Amount2, 0 AS Amount3, 0 AS Amount4, 0 AS Amount5,0 as DrAmount into Tmp_Aging1"
          ...
          ls_sql = ls_sql & " WHERE     (Gl_Detail.Acct_Type = 'D') "
          ...
          ls_sql = ls_sql & " SELECT Gl_Trans.accountno, 0 AS Amount1, round(SUM(Gl_Trans.Dr_Amount),0) AS Amount2, 0 AS Amount3, 0 AS Amount4, 0 AS Amount5,0 as DrAmount"
          ls_sql = ls_sql & " FROM Gl_Trans INNER JOIN  Gl_Detail ON Gl_Trans.compcode = Gl_Detail.compcode AND Gl_Trans.accountno = Gl_Detail.AccountNo"
          ls_sql = ls_sql & " WHERE     (Gl_Detail.Acct_Type = 'D') "
          ...
          ls_sql = ls_sql & " SELECT Gl_Trans.accountno, 0 AS Amount1, 0 AS Amount2,  round(SUM(Gl_Trans.Dr_Amount),0) AS Amount3, 0 AS Amount4, 0 AS Amount5,0 as DrAmount"
          ls_sql = ls_sql & " FROM Gl_Trans INNER JOIN  Gl_Detail ON Gl_Trans.compcode = Gl_Detail.compcode AND Gl_Trans.accountno = Gl_Detail.AccountNo"
          ls_sql = ls_sql & " WHERE     (Gl_Detail.Acct_Type = 'D') "
          ...
          ls_sql = ls_sql & " SELECT Gl_Trans.accountno, 0 AS Amount1, 0 AS Amount2, 0 AS Amount3,  round(SUM(Gl_Trans.Dr_Amount),0) AS Amount4, 0 AS Amount5,0 as DrAmount"
          ls_sql = ls_sql & " FROM Gl_Trans INNER JOIN  Gl_Detail ON Gl_Trans.compcode = Gl_Detail.compcode AND Gl_Trans.accountno = Gl_Detail.AccountNo"
          ls_sql = ls_sql & " WHERE     (Gl_Detail.Acct_Type = 'D') "
          ...
          ls_sql = ls_sql & " SELECT Gl_Trans.accountno, 0 AS Amount1, 0 AS Amount2, 0 AS Amount3, 0 as Amount4, round(SUM(Gl_Trans.Dr_Amount),0) AS Amount5,0 as DrAmount"
          ls_sql = ls_sql & " FROM Gl_Trans INNER JOIN  Gl_Detail ON Gl_Trans.compcode = Gl_Detail.compcode AND Gl_Trans.accountno = Gl_Detail.AccountNo"
          ls_sql = ls_sql & " WHERE     (Gl_Detail.Acct_Type = 'D') "
          ls_sql = ls_sql & " AND  DATEDIFF(day, Value_Date, '" & Format(dtpfrom, "YYYY/MM/DD") & "') >" & Val(Txtday41) & ""
          ...
          ls_sql = ls_sql & " SELECT Gl_Trans.accountno, 0 AS Amount1, 0 AS Amount2, 0 AS Amount3, 0 as Amount4,0 AS Amount5 , round(SUM(Gl_Trans.Cr_Amount),0) as DrAmount"
          ls_sql = ls_sql & " FROM Gl_Trans INNER JOIN  Gl_Detail ON Gl_Trans.compcode = Gl_Detail.compcode AND Gl_Trans.accountno = Gl_Detail.AccountNo"
          ls_sql = ls_sql & " WHERE     (Gl_Detail.Acct_Type = 'D') "
...
Private Sub Command5_Click()
    ...
    Gs_OtherPara = " Where Compcode = '" & Gs_compcode & "' and acct_type = 'D'"
