...
Begin VB.Form frmGlSub1 
   Caption         =   "Detail Accounts"
   ClientHeight    =   1980
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4950
   Icon            =   "frmGlSub1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":05EE
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":0A42
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":0E96
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":12EA
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":173E
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":1B92
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGlSub1.frx":22E6
               Key             =   ""
            EndProperty
         EndProperty
      End
...
' Setting up Preveliges
  ...
  PR_GlSub0.Open "Select *,acct_sub0 As MastAcctNo from gl_sub0 where compcode ='" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
  PR_GLSUB1.Open "Select *, acct_sub1 AcctNo from gl_sub1 where compcode ='" & Gs_compcode & "'", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
...
pr_dumy.Open "select max(acct_sub1) as acctno from gl_sub1 where compcode = '" & Gs_compcode & "' and acct_sub0 = '" & txtsub0 & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
...
Dim lb_found As Boolean
 ...
 If KeyCode = vbKeyReturn And Val(txtsub1.Text) > 0 Then
         ...
         End If
         PR_GLSUB1.Filter = "acct_sub0 = '" & txtsub0 & "'"
...
gc_dbcon.BeginTrans
     Select Case Mode
           Case "A"
              gc_dbcon.Execute "INSERT into gl_sub1 (compcode, Acct_Sub0, Acct_Sub1, Acct_Desc, UserId, AddDate, AddTime) VALUES ('" & Gs_compcode & "', '" & txtsub0 & "','" & txtsub1 & "' ,'" & txtdesc.Text & "','" & Gc_UserId & "','" & Format(Date, "YYYY/MM/DD") & "','" & Time & "')"
              
           Case "E"
              gc_dbcon.Execute "UPDATE gl_sub1 SET Acct_Desc= '" & txtdesc.Text & "' WHERE  compcode = '" & Gs_compcode & "' and acct_sub0= '" & txtsub0.Text & "' and acct_sub1= '" & txtsub1.Text & "'"
              
           Case "D"
              gc_dbcon.Execute "delete from gl_sub1  WHERE  compcode = '" & Gs_compcode & "' and acct_sub0= '" & txtsub0.Text & "' and acct_sub1= '" & txtsub1.Text & "'"
...
Private Sub cmdLookup0_Click()
    ...
    Set PO_CODE = txtsub0
    Set PO_DESC = Text1
    Gs_SQL = "Select acct_sub0 'Account No', Acct_Desc  'Description' from gl_sub0"
    Gs_FindFld = "Acct_Desc"
    Gs_Subon = False
    Gs_OtherPara = " Where Compcode = '" & Gs_compcode & "'"
    Gs_OrderBy = "Order by Acct_Desc,acct_sub0"
...
Private Sub cmdLookup1_Click()
    ...
    Set PO_CODE = txtsub1
    Set PO_DESC = txtdesc
    Gs_SQL = "Select acct_sub1 'Account No', Acct_Desc  'Description' from gl_sub1"
    Gs_FindFld = "Acct_Desc"
    Gs_Subon = False
    Gs_OtherPara = " Where Compcode = '" & Gs_compcode & "' and acct_sub0 = '" & txtsub0 & "' "
    Gs_OrderBy = "Order by Acct_Desc,acct_sub1"
    MyLookupOLDB.Caption = "Account Nos."
    MyLookupOLDB.Show 1
