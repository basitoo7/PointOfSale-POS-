VERSION 5.00
Begin VB.Form frmClientAccountSetup 
   ...
   ClientTop       =   435
   ClientWidth     =   6045
   Icon            =   "ClientAccountSetup.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1530
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdAccount1 
         Height          =   315
         Left            =   2730
         Picture         =   "ClientAccountSetup.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   2
         TabStop         =   0   'False
         Top             =   345
   ...
   End
End
Attribute VB_Name = "frmClientAccountSetup"
...
pr_dumyloadvalue.Open "Select * from ClientAccountSetup where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
If Not pr_dumyloadvalue.EOF Then
txtaccount1 = Trim(pr_dumyloadvalue("ClientAccount") & "")
...
ls_sql = "delete from ClientAccountSetup where compcode = '" & Gs_compcode & "'"
gc_dbcon.Execute ls_sql

ls_sql = "insert into  ClientAccountSetup (Compcode, ClientAccount)"
