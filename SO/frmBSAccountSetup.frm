VERSION 5.00
Begin VB.Form frmBSAccountSetup 
   ...
   ClientTop       =   435
   ClientWidth     =   6045
   Icon            =   "frmBSAccountSetup.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdAccount2 
         Height          =   315
         Left            =   2730
         Picture         =   "frmBSAccountSetup.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
         Top             =   720
      ...
      Begin VB.CommandButton CmdAccount1 
         Height          =   315
         Left            =   2730
         Picture         =   "frmBSAccountSetup.frx":047C
         Style           =   1  'Graphical
         TabIndex        =   2
         TabStop         =   0   'False
         Top             =   345
   ...
   End
End
Attribute VB_Name = "frmBSAccountSetup"
...
pr_dumyloadvalue.Open "Select * from ClientBSSetup where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
...
ls_sql = "delete from ClientBSSetup where compcode = '" & Gs_compcode & "'"
gc_dbcon.Execute ls_sql

ls_sql = "insert into  ClientBSSetup (Compcode, BsMainHead,BSNotes)"
