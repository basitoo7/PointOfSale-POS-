   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.CommandButton Command2 
            Height          =   315
            Left            =   2655
            Picture         =   "frmReceiableUnpost.frx":047C
            Style           =   1  'Graphical
            TabIndex        =   12
            TabStop         =   0   'False
            Top             =   180
...
Private Sub Command2_Click()
 Set PO_AnyForm = Nothing
    ...
    Set PO_DESC = Text1
        ...
        Gs_OtherPara = " where Compcode ='" & Gs_compcode & "' and Branchcode ='" & txtbranchcode & "' and  Transdate >='" & Format(dtpfrom, "YYYY/MM/DD") & "' and Transdate <='" & Format(dtpto, "YYYY/MM/DD") & "'"
...
Dim lb_found As Boolean
 ...
 ls_sql = "Select TransCode, TransDate from IC_Receiable where Compcode ='" & Gs_compcode & "' and Branchcode ='" & txtbranchcode & "'  and TransCode = '" & txtLocCode & "'"
