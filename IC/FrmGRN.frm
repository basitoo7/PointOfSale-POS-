      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":05EE
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":0A42
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":0E96
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":12EA
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":173E
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":1B92
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmGRN.frx":22E6
               Key             =   ""
            EndProperty
         EndProperty
      End
...
pr_dumy.Open "select max(transcode) as transcode from ic_trans where compcode = '" & Gs_compcode & "' and transtype = 'P'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
...
Private Sub Command5_Click()
    ...
    Gs_Subon = False
    Gs_OtherPara = " Where Compcode = '" & Gs_compcode & "' and Suppliercode <> '000000' "
...
Private Sub Form_Load()
  ...
  Pr_ICParty.Open "Select * from Ic_Supplier where compcode = '" & Gs_compcode & "' and Suppliercode <> '000000'  order by SupplierCode", gc_dbcon, adOpenStatic, adLockReadOnly, 1
  ...
  PR_ICISSU.Open "Select * from Ic_Trans where compcode ='" & Gs_compcode & "' and transtype = 'P' and referencecode is null  order by Transcode", gc_dbcon, adOpenDynamic, adLockOptimistic
...
gc_dbcon.BeginTrans
     ...
     Select Case Mode
           Case "D"
              gc_dbcon.Execute "DELETE FROM IC_Trans WHERE CompCode = '" & Gs_compcode & "' AND transcode = '" & Trim(txtTransNo) & "' and transtype = 'P'"
              gc_dbcon.Execute "DELETE FROM IC_Payments WHERE CompCode = '" & Gs_compcode & "' AND Referencecode = '" & Trim(txtTransNo) & "' and codeid = 'S'"
           ...
           Case Else
                ...
                With GrdGRN
                    For ln_cnt = 1 To .Rows - 1
                      ...
                      ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Trim(txtTransNo) & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "','" & Trim(txtpartycode) & "','" & Trim(.TextMatrix(ln_cnt, 1)) & "'," & (Val(0 & .TextMatrix(ln_cnt, 2))) & "," & Val(0 & .TextMatrix(ln_cnt, 3)) & "," & Val(0 & .TextMatrix(ln_cnt, 4)) & "," & Val(0 & .TextMatrix(ln_cnt, 4)) & "," & Val(0 & .TextMatrix(ln_cnt, 5)) & "," & Val(0 & .TextMatrix(ln_cnt, 6)) & ",'" & Trim(TxtRemarks) & "','" & Trim(txtsaleaccount) & "','" & Trim(txttaxaccount) & "','" & Trim(txtpartyaccount) & "','" & Trim(txtvchrtype) & "','" & Trim(txtvchrno) & "','" & Trim(.TextMatrix(ln_cnt, 7)) & "'," & Trim(.TextMatrix(ln_cnt, 8)) & ",'P')"
                 ...
                 'payments payable
                     pr_dumy.Open "select max(transcode) as transcode from ic_payments where compcode = '" & Gs_compcode & "' and codeid = 'S' ", gc_dbcon, adOpenStatic, adLockReadOnly, 1
                     If Not pr_dumy.EOF Then
                    ...
                    ls_sql = ls_sql & " Values ('" & Gs_compcode & "','" & txtpartycode & "','S','" & ls_transcode & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "'," & Val(0 & txttotalamount) & "," & Val(txttotaltaxamount) & ",'" & "Amount Payable To " + txtpartydesc & "','" & txtTransNo & "')"
                 ...
                 If Val(txtamountreceived) > 0 Then
                   pr_dumy.Open "select max(transcode) as transcode from ic_payments where compcode = '" & Gs_compcode & "' and codeid = 'S'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
                    ...
                    ls_sql = "Insert into IC_Payments( CompCode, Partycode,Codeid,TransCode, TransDate, Amount,Taxamount, Remarks,Referencecode) "
                    ls_sql = ls_sql & " Values ('" & Gs_compcode & "','" & txtpartycode & "','S','" & ls_transcode & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "'," & (-1) * Val(0 & txtamountreceived) & "," & (-1) * Val(txttaxreceived) & ",'" & "Amount paid to " + txtpartydesc & "','" & txtTransNo & "' )"
...
End If
    ...
    If Mode = "A" Or Mode = "E" Then
        ls_opt = SetErr("Print Purchase Invoice ?.", vbYesNo)
