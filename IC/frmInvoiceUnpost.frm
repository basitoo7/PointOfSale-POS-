...
Begin VB.Form frmInvoiceUnpost 
   ...
   EndProperty
   ForeColor       =   &H00000000&
   Icon            =   "frmInvoiceUnpost.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.CommandButton Command2 
            Height          =   315
            Left            =   3420
            Picture         =   "frmInvoiceUnpost.frx":030A
            Style           =   1  'Graphical
            TabIndex        =   12
            TabStop         =   0   'False
            Top             =   180
   ...
   End
End
Attribute VB_Name = "frmInvoiceUnpost"
...
pr_dumy1.Open "Select * from Ic_TransMaster where compcode = '" & Gs_compcode & "' and Transcode = '" & txtLocCode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
If Not pr_dumy1.EOF Then
    ...
    ls_sql = "Update Ic_TransMaster set Glstatus = 0 where compcode = '" & Gs_compcode & "' and Transcode = '" & txtLocCode & "'"
    gc_dbcon.Execute ls_sql
    
    Call MsgBox("Sale Reference Unpost Successfully", vbInformation)
    Call MsgBox("General Ledger Voucher Removed Successfully" + ls_vchrtype + "-" + ls_voucherno, vbInformation)
    
    txtLocCode = ""
Else
    Call MsgBox("Sale Reference not found", vbInformation)
    txtLocCode = ""
End If
...
Else
    Call MsgBox("Please Enter Sale Reference", vbInformation)
    txtLocCode.SetFocus
...
Private Sub Command2_Click()
 Set PO_AnyForm = Nothing
    ...
    Set PO_DESC = Text1
        ...
        Gs_SQL = "Select Transcode, TransDate from IC_TransMaster "
        ...
        MyLookupOLDB.Caption = "Sale Invoice"
        MyLookupOLDB.Show 1
...
Dim lb_found As Boolean
 ...
 ls_sql = "Select TransCode, TransDate from IC_TransMaster where Compcode ='" & Gs_compcode & "'  and TransCode = '" & txtLocCode & "'"
 pr_dumy.Open ls_sql, gc_dbcon, adOpenStatic, adLockReadOnly, 1
        If pr_dumy.EOF Then
            Call MsgBox("Sale Invoice not found !!!", vbCritical)
            txtLocCode = ""
            Text1 = ""
            txtLocCode.SetFocus
        Else
