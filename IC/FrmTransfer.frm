...
Begin VB.Form frmIssue 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":05EE
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":0A42
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":0E96
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":12EA
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":173E
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":1B92
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmTransfer.frx":22E6
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox txtitemtype 
         Height          =   330
         ItemData        =   "FrmTransfer.frx":273A
         Left            =   1200
         List            =   "FrmTransfer.frx":2744
...
pr_Dumy.Open "select max(transcode) as transcode from ic_trans where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
If Not pr_Dumy.EOF Then
    maxtranscode = DoPad(Trim(Str(Int(pr_Dumy("transcode")) + 1)), 10)
Else
...
Private Sub Command5_Click()
    ...
    Gs_Subon = False
    Gs_OtherPara = " Where Compcode = '" & Gs_compcode & "' and codeid = 'C'"
...
Private Sub Form_Load()
  ...
  Pr_ICParty.Open "Select * from Ic_Supplier where compcode = '" & Gs_compcode & "' and codeid = 'C' order by SupplierCode", gc_dbcon, adOpenStatic, adLockReadOnly, 1
  ...
  PR_IcItem.Open "Select * from Ic_Item ", gc_dbcon, adOpenDynamic, adLockPessimistic, 1
  PR_ICISSU.Open "Select * from Ic_Trans where compcode ='" & Gs_compcode & "'  order by Transcode", gc_dbcon, adOpenDynamic, adLockOptimistic
...
If KeyCode = vbKeyReturn Then
        If txtitemtype = "Box" Then
               txtunitprice = PR_IcItem("TotalSaleprice")
        Else
            txtunitprice = PR_IcItem("Saleprice")
        End If
...
Private Sub txtPartyCode_KeyDown(KeyCode As Integer, Shift As Integer)
 If KeyCode = vbKeyReturn And txtpartycode.Text <> "" Then
         ...
         If Not MySeek(txtpartycode.Text, "SupplierCode", Pr_ICParty) Then
...
Private Sub txtpartycode_LostFocus()
enterkeystatus = True
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If PB_BlnkGRN And Range(Button.Index, 2, 3) Then
       ...
       Cancel = True
    Else
       Mode = DentMode(Mode, Button.Index, PR_ICISSU, Me, txtvaluedate, txtvaluedate, Para_Rs, "IC_ISSuCnt", 10, "txtTransNo", "text1", 1, False, Toolbar1)
    End If
    If Mode = "A" Then
     '  txtVchrType = "JVS"
...
gc_dbcon.BeginTrans
     ...
     Select Case Mode
           Case "D"
              gc_dbcon.Execute "DELETE FROM IC_Trans WHERE CompCode = '" & Gs_compcode & "' AND transcode = '" & Trim(txtTransNo) & "'"
              
              gc_dbcon.Execute "DELETE FROM Gl_Trans WHERE CompCode = '" & Gs_compcode & "' And BranchCode = '" & Gs_BranchCode & "' AND Voucher_No = '" & txtvchrno & "' AND VchrType = '" & txtvchrtype & "' and month(value_date) = " & Month(txtvaluedate.Value) & " and year(value_date) = " & Year(txtvaluedate.Value) & ""
              gc_dbcon.Execute "DELETE FROM Gl_Ref WHERE CompCode = '" & Gs_compcode & "' And BranchCode = '" & Gs_BranchCode & "' AND Voucher_No = '" & txtvchrno & "' AND VchrType = '" & txtvchrtype & "' and month(value_date) = " & Month(txtvaluedate.Value) & " and year(value_date) = " & Year(txtvaluedate.Value) & ""
           ...
           Case Else
                ...
                With GrdGRN
                    For ln_cnt = 1 To .Rows - 1
                      ls_Sql = "INSERT into IC_Trans(Compcode, TransCode, SaleDate, PartyCode, ItemCode, Quantity, ItemRate, Amount, STaxRate, SaleTaxAmount, Remarks, SaleAccount, TaxAccount, "
                      ls_Sql = ls_Sql & " PartyAccount, VchrType, VoucherNo,itemtype,noofitems,Transtype)"
                      ls_Sql = ls_Sql & " VALUES ('" & Gs_compcode & "','" & Trim(txtTransNo) & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "','" & Trim(txtpartycode) & "','" & Trim(.TextMatrix(ln_cnt, 1)) & "'," & (Val(0 & .TextMatrix(ln_cnt, 2))) & "," & Val(0 & .TextMatrix(ln_cnt, 3)) & "," & Val(0 & .TextMatrix(ln_cnt, 4)) & "," & Val(0 & .TextMatrix(ln_cnt, 5)) & "," & Val(0 & .TextMatrix(ln_cnt, 6)) & ",'" & Trim(TxtRemarks) & "','" & Trim(txtsaleaccount) & "','" & Trim(txttaxaccount) & "','" & Trim(txtpartyaccount) & "','" & Trim(txtvchrtype) & "','" & Trim(txtvchrno) & "','" & Trim(.TextMatrix(ln_cnt, 7)) & "'," & Trim(.TextMatrix(ln_cnt, 8)) & ",'S')"
...
End If
    ...
    If Mode = "A" Or Mode = "E" Then
        ls_opt = SetErr("Print Invoice ?.", vbYesNo)
...
On Error GoTo LocalErr
   ...
   With CrystalReport1
        ...
        .Formulas(0) = "CompanyName = '" & Gs_CompName & "'"
        .Formulas(2) = "Reportname = 'Sale Tax Invoice'"
...
Dim ln_cnt As Integer
 ...
 If KeyCode = vbKeyReturn And Len(TxtItemCode.Text) > 0 Then
         ...
         TxtItemCode.Text = DoPad(Trim(TxtItemCode.Text), 3)
...
Private Sub grdGRN_DblClick()
    With GrdGRN
        ...
        txtitemtype = Val(.TextMatrix(.Row, 7))
