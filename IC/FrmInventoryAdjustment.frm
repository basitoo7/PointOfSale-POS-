...
Begin VB.Form frmInventoryAdjustment 
   ...
   EndProperty
   Icon            =   "FrmInventoryAdjustment.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox txtadjin 
         Height          =   330
         ItemData        =   "FrmInventoryAdjustment.frx":030A
         Left            =   10140
         List            =   "FrmInventoryAdjustment.frx":0314
      ...
      Begin VB.ComboBox txtinventorytype 
         Height          =   330
         ItemData        =   "FrmInventoryAdjustment.frx":032A
         Left            =   6645
         List            =   "FrmInventoryAdjustment.frx":0334
         Style           =   2  'Dropdown List
         TabIndex        =   24
         Top             =   165
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         Height          =   315
         Left            =   1500
         Picture         =   "FrmInventoryAdjustment.frx":0355
         Style           =   1  'Graphical
         TabIndex        =   21
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin VB.CommandButton Command3 
         Height          =   315
         Left            =   7470
         Picture         =   "FrmInventoryAdjustment.frx":04C7
         Style           =   1  'Graphical
         TabIndex        =   18
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin VB.CommandButton Command1 
         Height          =   315
         Left            =   2160
         Picture         =   "FrmInventoryAdjustment.frx":0639
         Style           =   1  'Graphical
         TabIndex        =   12
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":07AB
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":0BFF
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":1053
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":14A7
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":18FB
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":1D4F
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryAdjustment.frx":24A3
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmInventoryAdjustment"
...
Private Sub Command1_Click()
    ...
    Gs_OtherPara = "Where Compcode = '" & Gs_compcode & "'  and glstatus = 0 and invtype =1"
...
Private Sub txtTransNo_KeyDown(KeyCode As Integer, Shift As Integer)
 ...
 If KeyCode = vbKeyReturn And Len(txttransno.Text) > 0 Then
         ...
         PR_ICIssue.Open "select * from IC_InventoryAdjMaster where compcode = '" & Gs_compcode & "' and Transcode = '" & txttransno & "' and glstatus = 0 and invtype =1 ", gc_dbcon, adOpenStatic, adLockReadOnly, 1
       Select Case Mode
            Case "A"
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Mode = "A" Then
       txttransno = maxtranscode
       TxtRemarks = "Adjustment of Out Inventory"
       txtadjin.SetFocus
       CheckLogTrans
    End If
End Sub
     ...
     Select Case Mode
           ...
           Case Else
                ...
                End If
                      ...
                      ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "','000001','001','001','" & RepApp(TxtRemarks) & "','" & txtacode & "','" & txtacode1 & "','" & Gc_UserId & "','" & Format(Date, "YYYY/MM/DD") & "','" & Time & "',1," & txtadjin.ListIndex + 1 & "  )"
                ...
                With GrdGRN
                    ...
                    End If
                      ...
                      If .TextMatrix(ln_cnt, 1) <> "" Then
                        ...
                        ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Trim(.TextMatrix(ln_cnt, 1)) & "','" & Trim(.TextMatrix(ln_cnt, 12)) & "'," & Val(0 & .TextMatrix(ln_cnt, 4)) & "," & Val(0 & .TextMatrix(ln_cnt, 5)) & "," & Val(0 & .TextMatrix(ln_cnt, 6)) & "," & ln_Adj & "," & Val(0 & .TextMatrix(ln_cnt, 8)) & "," & Val(0 & .TextMatrix(ln_cnt, 9)) & "," & Val(0 & .TextMatrix(ln_cnt, 10)) & " , '" & Trim(.TextMatrix(ln_cnt, 11)) & "' )"
                        gc_dbcon.Execute ls_sql
                     End If
                    Next
                 End With
...
If Not Pr_LoadTrans.EOF Then
        With GrdGRN
            Do While Not Pr_LoadTrans.EOF
                ...
                ls_sql = "INSERT into IC_InventoryAdjDetailLog(Compcode,BranchCode, TransCode,customcode, ItemCode, Stockinhand,Quantity,stockonshelf,invtype, ItemRate, Amount,AvgRate,Remarks,ComputerName,rowid,EMode)"
