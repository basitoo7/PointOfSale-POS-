...
Begin VB.Form frmICSAgreement 
   Caption         =   "Sale Agreement"
   ClientHeight    =   6780
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7155
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":030A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":075E
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":0BB2
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":1006
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":145A
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":18AE
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmICSAgreement.frx":2002
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   315
         Left            =   1935
         Picture         =   "frmICSAgreement.frx":2456
         Style           =   1  'Graphical
         TabIndex        =   54
         Tag             =   "SKIP"
         Top             =   930
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   315
         Left            =   2415
         Picture         =   "frmICSAgreement.frx":25C8
         Style           =   1  'Graphical
         TabIndex        =   52
         Tag             =   "SKIP"
         Top             =   180
         Width           =   300
      End
      Begin VB.TextBox txtstranscode 
         BackColor       =   &H00FFFF80&
         Height          =   315
         Left            =   1215
         MaxLength       =   10
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton Command3 
            ...
            Height          =   315
            Left            =   1800
            Picture         =   "frmICSAgreement.frx":273A
            Style           =   1  'Graphical
            TabIndex        =   43
            Tag             =   "SKIP"
            Top             =   630
      ...
      Begin VB.CommandButton cmdlookup2 
         ...
         Height          =   315
         Left            =   1920
         Picture         =   "frmICSAgreement.frx":28AC
         Style           =   1  'Graphical
         TabIndex        =   18
         Tag             =   "SKIP"
         Top             =   2025
      ...
      Begin VB.CommandButton CmdLookUp8 
         ...
         Height          =   315
         Left            =   1905
         Picture         =   "frmICSAgreement.frx":2A1E
         Style           =   1  'Graphical
         TabIndex        =   15
         Tag             =   "SKIP"
         Top             =   2400
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   315
         Left            =   5880
         Picture         =   "frmICSAgreement.frx":2B90
         Style           =   1  'Graphical
         TabIndex        =   9
         Tag             =   "SKIP"
         Top             =   165
      ...
      Begin VB.CommandButton cmdLookup 
         ...
         Height          =   315
         Left            =   1935
         Picture         =   "frmICSAgreement.frx":2D02
         Style           =   1  'Graphical
         TabIndex        =   7
         Tag             =   "SKIP"
         Top             =   555
   ...
   End
End
Attribute VB_Name = "frmICSAgreement"
...
Public Pr_SAgreement As New Recordset
...
Private Sub Command4_Click()
    Set PO_AnyForm = Nothing
    Set PO_AnyForm = Me
    Set PO_CODE = txtstranscode
    Set PO_DESC = Text1
    Gs_SQL = "Select STransCode,AgrDate from IC_SAgreement "
    Gs_FindFld = "STransCode"
    Gs_OrderBy = "Order by STransCode,AgrDate"
    
    MyLookupOLDB.Caption = "Sale Reference"
    MyLookupOLDB.Show 1
    
    If Trim(txtstranscode) <> "" Then Call txtStranscode_KeyDown(vbKeyReturn, vbKeyShift)
...
Private Sub txttranscode_KeyDown(KeyCode As Integer, Shift As Integer)
 ...
 End If
End Sub
Private Sub txtStranscode_KeyDown(KeyCode As Integer, Shift As Integer)
 If KeyCode = vbKeyReturn Then
         txtstranscode.Text = DoPad(txtstranscode.Text, txtstranscode.MaxLength)
         If Not MySeek(txtstranscode.Text, "StransCode", Pr_SAgreement) Then
            Call SetErr(Gs_RecNFMsg, vbCritical)
            txtstranscode.SetFocus
         Else
          Call SetVal
        End If
 End If
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
 If KeyCode = vbKeyF11 Then Mode = DentMode(Mode, 4, Pr_Agreement, Me, txttranscode, txtCustomer, PR_Para, "ICSACnt", 10, " CustomerNo", "CustomerName", 0, False, Toolbar1)
End Sub
Private Sub Form_Load()
  ...
  PR_Customer.Open "Select Ic_Customer.* from Ic_Customer where compcode = '" & Gs_compcode & "' order by customerCode ", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
  Pr_Agreement.Open "Select IC_PAgreement.* from IC_PAgreement where compcode = '" & Gs_compcode & "' order by PTranscode ", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
  Pr_SAgreement.Open "Select IC_SAgreement.* from IC_SAgreement where compcode = '" & Gs_compcode & "' order by STransCode ", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
  ...
  PR_Para.Open "select ICSACnt from Syscomp where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
...
Private Sub cmdLookup_Click()
    Set PO_AnyForm = Nothing
    Set PO_AnyForm = Me
    Set PO_CODE = txtCustomer
    Set PO_DESC = txtName
    Gs_SQL = "Select CustomerCode 'Customer Code', CustomerName  'Customer Name' from Ic_Customer "
    Gs_FindFld = "CustomerName"
    Gs_OrderBy = "Order by CustomerCode,CustomerName"
    Gs_OtherPara = " Where compcode = '" & Gs_compcode & "' "
    MyLookupOLDB.Caption = "Customers"
    MyLookupOLDB.Show 1
    If Trim(txtCustomer) <> "" Then Call txtCustomer_KeyDown(vbKeyReturn, vbKeyShift)
End Sub
...
txtprofit = (txtqty * (txtrate - txtprate))
...
Dim lb_found As Boolean
 If KeyCode = vbKeyReturn And Len(txtCustomer.Text) > 0 Then
         txtCustomer.Text = DoPad(txtCustomer, txtCustomer.MaxLength)
         lb_found = MySeek(txtCustomer.Text, "CustomerCode", PR_Customer)
          
          If Not lb_found Then
               Call SetErr(Gs_RecNFMsg, vbCritical)
               txtCustomer.SetFocus
          Else
               txtName = Trim(PR_Customer("Customername") & "")
               txtptype.SetFocus
          End If
 End If
 End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    If PB_BlnkSupp And Range(Button.Index, 2, 3) Then
       ...
       Cancel = True
    Else
       Mode = DentMode(Mode, Button.Index, Pr_Agreement, Me, txtstranscode, txttranscode, PR_Para, "ICSACnt", 10, " CustomerNo", "CustomerName", 0, False, Toolbar1)
    End If
End Sub
...
gc_dbcon.BeginTrans
     ...
     Select Case Mode
           Case "D"
                gc_dbcon.Execute "DELETE FROM IC_SAgreement WHERE CompCode = '" & Gs_compcode & "' and STransCode = '" & txtstranscode & "' "
                gc_dbcon.Execute "DELETE FROM IC_SSchedule WHERE CompCode = '" & Gs_compcode & "' and STransCode = '" & txtstranscode & "' "
           Case Else
                 If Mode = "E" Then
                     gc_dbcon.Execute "DELETE FROM IC_SAgreement WHERE CompCode = '" & Gs_compcode & "' and STransCode = '" & txtstranscode & "' "
                     gc_dbcon.Execute "DELETE FROM IC_SSchedule WHERE CompCode = '" & Gs_compcode & "' and STransCode = '" & txtstranscode & "' "
             ...
             End If
                    ...
                    ls_sql = "Insert into   IC_SAgreement(CompCode, STransCode,PTransCode, CustomerCode, PType, Amount, DAmount, Rate, AgrDate, PMode, BankCode, BankAccount, GLAccountNo, Transdate,Status,qty,Profitamount) "
                    ls_sql = ls_sql + " VALUES  ('" & Gs_compcode & "','" & txtstranscode & "','" & txttranscode & "','" & Trim(txtCustomer.Text) & "','" & Trim(txtptype) & "'," & Val(txttotalamount) & "," & Val(txtamountpaid) & "," & txtrate & ", '" & Format(DTPAgr, "YYYY/MM/DD") & "','" & Trim(txtpmode) & "' ,'" & Trim(txtbank) & "'  ,'" & txtaccountno & "','" & ls_Accountno & "','" & Format(Date, "YYYY/MM/DD") & "',1," & Val(txtqty) & " ," & Val(txtprofit) & " )"
                    gc_dbcon.Execute ls_sql
                    
                    With grdVoucher
                       For ln_cnt = 1 To .Rows - 1
                          If Len(Trim(.TextMatrix(ln_cnt, 1))) > 0 Then
                           gc_dbcon.Execute "INSERT into IC_SSchedule(CompCode, STransCode, AccrualDate, DueAmount,BankCode,Instrno,Instno) VALUES ('" & Gs_compcode & "','" & txtstranscode & "','" & Format(.TextMatrix(ln_cnt, 1), "YYYY/MM/DD") & "'," & .TextMatrix(ln_cnt, 2) & ",'" & .TextMatrix(ln_cnt, 3) & "','" & .TextMatrix(ln_cnt, 4) & "','" & DoPad(Trim(Str(.TextMatrix(ln_cnt, 0))), 3) & "')"
                          End If
                       Next
                     End With
...
Private Sub PrintSchedule()
          With Crrpt
            ...
            .SelectionFormula = "{IC_SAgreement.PtransCode} ='" & txttranscode & "'"
...
Dim ls_Narration, ls_acctname, ls_accounts1, ls_accounts As String
            ...
            ' Increment in Voucher Counter
             ...
             ' Save References of Voucher
               ...
               gc_dbcon.Execute "INSERT into Gl_Trans(compcode,BranchCode,AccountNo, SerialNo, Value_Date, Voucher_No, VchrType, Dr_Amount, Cr_Amount, userid,adddate,addtime,Acct_Nirration,AcctName) VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & ls_accounts1 & "',1,'" & Format(DTPAgr, "YYYY/MM/DD") & "','" & ls_Vchrno & "','" & ls_VchrType & "'," & Val(txtamount) & ",0 ,'" & Gc_UserId & "','" & Format(Date, "YYYY/MM/DD") & "','" & Time & "','" & ls_Narration & "','" & ls_acctname & "')"

                
                ls_Accountno = "002002001" + txtSupplier
               ...
               gc_dbcon.Execute "INSERT into Gl_Trans(compcode,BranchCode,AccountNo, SerialNo, Value_Date, Voucher_No, VchrType, Dr_Amount, Cr_Amount, userid,adddate,addtime,Acct_Nirration,AcctName) VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & ls_accounts & "',2,'" & Format(DTPAgr, "YYYY/MM/DD") & "','" & ls_Vchrno & "','" & ls_VchrType & "',0," & Val(txtamount) & " ,'" & Gc_UserId & "','" & Format(Date, "YYYY/MM/DD") & "','" & Time & "','" & ls_Narration & "','" & ls_acctname & "')"
...
End Sub
Private Sub SetVal()
     DTPAgr = Pr_SAgreement("AgrDate")
     txttotalamount = Val(0 & Pr_SAgreement("Amount"))
     txtqty = Val(0 & Pr_SAgreement("Qty"))
     txtrate = Val(0 & Pr_SAgreement("Rate"))
     txtprate = txtrate
     txtamountpaid = Val(0 & Pr_SAgreement("DAmount"))
     txtptype = Trim(Pr_SAgreement("Ptype") & "")
     If txtptype <> "" Then Call txtptype_KeyDown(vbKeyReturn, vbKeyShift)
     txtpmode = Trim(Pr_SAgreement("PMode") & "")
     If txtpmode <> "" Then Call txtpmode_KeyDown(vbKeyReturn, vbKeyShift)
     txtbank = Trim(Pr_SAgreement("Bankcode") & "")
     If txtbank <> "" Then Call txtbank_KeyDown(vbKeyReturn, vbKeyShift)
     txtaccountno = Trim(Pr_SAgreement("BankAccount") & "")
     txtCustomer = Trim(Pr_SAgreement("Customercode") & "")
     If txtCustomer <> "" Then Call txtCustomer_KeyDown(vbKeyReturn, vbKeyShift)
     LoadSchedule
End Sub
...
pr_dumy.Open "Select * from ic_SSchedule where Stranscode = '" & txtstranscode & "' and compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockPessimistic, adCmdText
InitializeGrid
...
Public Function ChkInputs() As Boolean
    If Len(txtCustomer.Text) = txtCustomer.MaxLength And Trim(txtptype) <> "" And txttotalamount <> "" And Trim(txtrate) <> "" And Trim(txtqty) <> "" Then
       ChkInputs = True
    Else
