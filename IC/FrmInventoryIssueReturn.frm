...
Begin VB.Form frmInventoryIssueReturn 
   Caption         =   "Stock Issue Note Return"
   ClientHeight    =   6000
   ClientLeft      =   60
   ClientTop       =   645
   ClientWidth     =   12345
   ...
   EndProperty
   Icon            =   "FrmInventoryIssueReturn.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command2 
         Height          =   315
         Left            =   1500
         Picture         =   "FrmInventoryIssueReturn.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   22
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin VB.CommandButton Command3 
         Height          =   315
         Left            =   7470
         Picture         =   "FrmInventoryIssueReturn.frx":047C
         Style           =   1  'Graphical
         TabIndex        =   19
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin VB.CommandButton Command1 
         Height          =   315
         Left            =   2160
         Picture         =   "FrmInventoryIssueReturn.frx":05EE
         Style           =   1  'Graphical
         TabIndex        =   13
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":0760
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":0BB4
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":1008
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":145C
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":18B0
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":1D04
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryIssueReturn.frx":2458
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmInventoryIssueReturn"
...
pr_dumy.Open "select max(transcode) as transcode from IC_IssueReturnNoteMaster where compcode = '" & Gs_compcode & "' ", gc_dbcon, adOpenStatic, adLockReadOnly, 1
...
Private Sub New_Record_Click()
       ...
       Mode = DentMode(Mode, 1, PR_ICIssue, Me, txttransno, txttransno, Para_Rs, "IC_ISSuCnt", 10, "txtTransNo", "text1", 1, False, Toolbar1)
        TxtRemarks = "Stock return from Showroom"
       TxtRemarks.SetFocus
End Sub
...
gc_dbcon.BeginTrans
     ...
     Select Case Mode
           Case "D"
              gc_dbcon.Execute "DELETE FROM IC_IssueReturnNoteMaster WHERE CompCode = '" & Gs_compcode & "' AND transcode = '" & Trim(txttransno) & "'"
              gc_dbcon.Execute "DELETE FROM IC_IssueReturnNoteDetail WHERE CompCode = '" & Gs_compcode & "' AND transcode = '" & Trim(txttransno) & "'"
           ...
           Case Else
                ...
                End If
                      ...
                      ls_sql = "INSERT into IC_IssueReturnNoteMaster( Compcode,branchcode, TransCode,   TransDate, AccountCode, SiteID, BinID, Remarks,vcode,acode,userid,adddate,addtime)"
                      ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "','000001','001','001','" & RepApp(TxtRemarks) & "','" & txtacode & "','" & txtacode1 & "','" & Gc_UserId & "','" & Format(Date, "YYYY/MM/DD") & "','" & Time & "' )"
                      gc_dbcon.Execute ls_sql
                
                With GrdGRN
                    For ln_cnt = 1 To .Rows - 1
                      If .TextMatrix(ln_cnt, 1) <> "" Then
                        ls_sql = "INSERT into IC_IssueReturnNoteDetail(Compcode,BranchCode, TransCode,customcode, ItemCode, Quantity, ItemRate, Amount,AvgRate,Remarks)"
                        ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Trim(.TextMatrix(ln_cnt, 1)) & "','" & Trim(.TextMatrix(ln_cnt, 12)) & "'," & Val(0 & .TextMatrix(ln_cnt, 4)) & "," & Val(0 & .TextMatrix(ln_cnt, 7)) & "," & Val(0 & .TextMatrix(ln_cnt, 6)) & "," & Val(0 & .TextMatrix(ln_cnt, 5)) & " , '" & Trim(.TextMatrix(ln_cnt, 8)) & "' )"
                        gc_dbcon.Execute ls_sql
                     End If
                    Next
                 End With
...
If Mode <> "D" Then
   ls_opt = MsgBox("Print Issue Return Note ?.", vbYesNo)
...
On Error GoTo LocalErr
   ...
   With rptVoucher
        ...
        .Formulas(2) = "Reportname = 'Issue Return Note'"
 ...
 Dim lb_opt As Boolean
    ...
    Else
        ...
        With GrdGRN
          For ln_cnt = 1 To .Rows - 1
           If .TextMatrix(ln_cnt, 1) <> "" Then
            If Val(.TextMatrix(ln_cnt, 4)) = 0 Then
...
Private Sub InitializeGrid()
    With GrdGRN
        ...
        .Clear
        .Rows = 2
        .FormatString = "Sr# |<Custom Code|<Item Name|<UOM|<Qty|<Avg Rate|<Total|<ItemRate|<Remarks|<JobQty|<JobIssueQty|<GQty|<Itemcode|<SQty"
        .ColWidth(1) = 1500
        .ColWidth(2) = 4000
        .ColWidth(3) = 1100
        .ColWidth(4) = 900
...
ls_sql = " SELECT IC_IssueReturnNoteDetail.CustomCode,IC_IssueReturnNoteDetail.ItemCode, IC_Item.Description, IC_IssueReturnNoteDetail.Quantity, IC_IssueReturnNoteDetail.ItemRate, IC_IssueReturnNoteDetail.Amount, IC_ItemUM.Description AS UOM,IC_IssueReturnNoteDetail.AvgRate,IC_IssueReturnNoteDetail.Remarks "
ls_sql = ls_sql & " FROM IC_IssueReturnNoteDetail INNER JOIN   IC_Item ON IC_IssueReturnNoteDetail.Compcode = IC_Item.Compcode AND IC_IssueReturnNoteDetail.ItemCode = IC_Item.ItemCode INNER JOIN  IC_ItemUM ON IC_Item.MCode = IC_ItemUM.Mcode"
ls_sql = ls_sql & "  where IC_IssueReturnNoteDetail.Compcode = '" & Gs_compcode & "' and IC_IssueReturnNoteDetail.Transcode = '" & txttransno & "'"
...
If Not Pr_LoadTrans.EOF Then
        With GrdGRN
            Do While Not Pr_LoadTrans.EOF
                ...
                .TextMatrix(.Row, 7) = Val(0 & Pr_LoadTrans("Itemrate"))
                .TextMatrix(.Row, 6) = Val(0 & Pr_LoadTrans("amount"))
                .TextMatrix(.Row, 5) = Val(0 & Pr_LoadTrans("AvgRate"))
                .TextMatrix(.Row, 8) = Trim(Pr_LoadTrans("Remarks") & "")
                .TextMatrix(.Row, 9) = 0
                .TextMatrix(.Row, 10) = 0
                .TextMatrix(.Row, 11) = CheckBalQTY(.TextMatrix(.Row, 12), 1)
                .TextMatrix(.Row, 13) = CheckBalQTY(.TextMatrix(.Row, 12), 2)
                .Rows = .Rows + 1
  ...
  With argFlexGrid
    ...
    If .Col = 1 Then
          ...
          Else
             ...
             .TextMatrix(.Row, 7) = PR_IcItem("Purchasecost")
             .TextMatrix(.Row, 5) = PR_IcItem("AvgRate")
             .TextMatrix(.Row, 9) = 0
             .TextMatrix(.Row, 10) = 0
