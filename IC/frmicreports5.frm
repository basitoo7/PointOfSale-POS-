...
Begin VB.Form frmicreport5 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.CommandButton Command5 
               Height          =   315
               Left            =   2235
               Picture         =   "frmicreports5.frx":030A
               Style           =   1  'Graphical
               TabIndex        =   10
               TabStop         =   0   'False
               Top             =   180
   ...
   End
End
Attribute VB_Name = "frmicreport5"
...
MDIForm1.StatusBar1.Panels(7).Text = "Processing Data Please Wait..."
    With crrpt
        ...
        .Formulas(1) = "ReportName = 'Clients Receiable(Summary)'"
        .ReportFileName = App.Path & Gs_ICRepoPath & "\Accounthistoryclients.RPT"
        ElseIf Option3.Value = True Then
        .Formulas(1) = "ReportName = 'Client Receiables (Summary)'"
        .ReportFileName = App.Path & Gs_ICRepoPath & "\AccounthistoryClientssum.RPT"
        Else
        .Formulas(1) = "ReportName = 'Client Receiables (Detail)'"
        .ReportFileName = App.Path & Gs_ICRepoPath & "\AccounthistoryClientsdetail.RPT"
        End If
        ...
        .SQLQuery = .SQLQuery & "  AND IC_TransMaster.transdate <= '" & Format(dtpfrom, "YYYY/MM/DD") & "'"
        
        
        If Not Trim(txtselectedcode) = "" Then
        .SQLQuery = .SQLQuery & " AND Ic_TransMaster.clientCode = '" & Trim(txtselectedcode) & "'"
        End If
