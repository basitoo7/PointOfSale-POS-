...
Begin VB.Form frmDepartments 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdLookup 
         ...
         Height          =   315
         Left            =   2040
         Picture         =   "frmDepartments.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   3
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":047C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":08D0
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":0D24
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":1178
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":15CC
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":1A20
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmDepartments.frx":2174
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private Sub cmdLookup_Click()
    ...
    MyLookupOLDB.Caption = "Company Departments"
    MyLookupOLDB.Show 1
...
Private Sub Form_Load()
  ...
  PR_Departments.Open "Select * from IC_Departments where compcode ='" & Gs_compcode & "'", gc_dbcon, adOpenDynamic, adLockOptimistic, 1
...
Dim pr_dumy As New Recordset
    pr_dumy.Open "select max(DeptCode) as transcode from IC_Departments where compcode = '" & Gs_compcode & "'", gc_dbcon, adOpenStatic, adLockReadOnly, 1
...
Dim lb_found As Boolean
 ...
 If Lastkey(KeyCode) Then
         ...
         lb_found = MySeek(txtLocation.Text, "DeptCode", PR_Departments)
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If PB_BlnkLoca And Range(Button.Index, 2, 3) Then
       ...
       'Cancel = True
    Else
       Mode = DentMode(Mode, Button.Index, PR_Departments, Me, txtLocation, txtdesc, "X", "CompCount", 3, "DeptCode", "Description", 1, False, Toolbar1)
    End If
...
gc_dbcon.BeginTrans
     Select Case Mode
           Case "A"
              ls_sql = "INSERT into IC_Departments(compcode,DeptCode,Description,PerAmount,FixAmount) VALUES ('" & Gs_compcode & "','" & txtLocation.Text & "','" & RepApp(txtdesc.Text) & "',0,0 )"
              gc_dbcon.Execute ls_sql
              
           Case "E"
              ls_sql = "UPDATE IC_Departments SET Description= '" & RepApp(txtdesc.Text) & "' WHERE  compcode = '" & Gs_compcode & "' and DeptCode= '" & txtLocation.Text & "'"
              gc_dbcon.Execute ls_sql
             
           Case "D"
              ls_sql = "DELETE FROM IC_Departments WHERE DeptCode = '" & txtLocation.Text & "' and compcode = '" & Gs_compcode & "'"
              gc_dbcon.Execute ls_sql
...
Private Sub SetVal()
     txtdesc = PR_Departments("Description")
End Sub
