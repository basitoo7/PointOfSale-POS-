...
Begin VB.Form FrmInventoryInAdjustment 
   ...
   EndProperty
   Icon            =   "FrmInventoryInAdjustment.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox txtadjin 
         Height          =   330
         ItemData        =   "FrmInventoryInAdjustment.frx":030A
         Left            =   10140
         List            =   "FrmInventoryInAdjustment.frx":0314
      ...
      Begin VB.ComboBox txtinventorytype 
         Height          =   330
         ItemData        =   "FrmInventoryInAdjustment.frx":032A
         Left            =   6645
         List            =   "FrmInventoryInAdjustment.frx":0334
         Style           =   2  'Dropdown List
         TabIndex        =   24
         Top             =   165
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         Height          =   315
         Left            =   1920
         Picture         =   "FrmInventoryInAdjustment.frx":0355
         Style           =   1  'Graphical
         TabIndex        =   21
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin VB.CommandButton Command3 
         Height          =   315
         Left            =   7800
         Picture         =   "FrmInventoryInAdjustment.frx":04C7
         Style           =   1  'Graphical
         TabIndex        =   18
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin VB.CommandButton Command1 
         Height          =   315
         Left            =   2160
         Picture         =   "FrmInventoryInAdjustment.frx":0639
         Style           =   1  'Graphical
         TabIndex        =   12
         TabStop         =   0   'False
         Tag             =   "SKIP"
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":07AB
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":0BFF
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":1053
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":14A7
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":18FB
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":1D4F
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "FrmInventoryInAdjustment.frx":24A3
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "FrmInventoryInAdjustment"
...
Private Sub GrdGRN_SelChange()
GrdGRN.SelectionMode = flexSelectionFree
With GrdGRN
   txtitemname = .TextMatrix(.Row, 2)
   txtitemcode.Text = .TextMatrix(.Row, 12)
   txtCat.Text = .TextMatrix(.Row, 14)
   txtSubCat.Text = .TextMatrix(.Row, 16)
End With
...
Private Sub Command1_Click()
    ...
    Gs_OtherPara = "Where Compcode = '" & Gs_compcode & "'  and glstatus = 0 and invtype =0"
...
Private Sub txtTransNo_KeyDown(KeyCode As Integer, Shift As Integer)
 ...
 If KeyCode = vbKeyReturn And Len(txttransno.Text) > 0 Then
         ...
         PR_ICIssue.Open "select * from IC_InventoryAdjMaster where compcode = '" & Gs_compcode & "' and Transcode = '" & txttransno & "' and glstatus = 0 and invtype =0 ", gc_dbcon, adOpenStatic, adLockReadOnly, 1
       Select Case Mode
            Case "A"
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Mode = "A" Then
       txttransno = maxtranscode
       TxtRemarks = "Adjustment of In Inventory"
       txtadjin.SetFocus
       CheckLogTrans
    End If
...
gc_dbcon.BeginTrans
     ...
     Select Case Mode
           Case "D"
              gc_dbcon.Execute "DELETE FROM IC_InventoryAdjMaster WHERE CompCode = '" & Gs_compcode & "' AND transcode = '" & Trim(txttransno) & "'"
           ...
           Case Else
                ...
                End If
                      ...
                      ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Format(txtvaluedate, "YYYY/MM/DD") & "','000001','001','001','" & RepApp(TxtRemarks) & "','" & txtacode & "','" & txtacode1 & "','" & Gc_UserId & "','" & Format(Date, "YYYY/MM/DD") & "','" & Time & "',0," & txtadjin.ListIndex + 1 & "  )"
                ...
                With GrdGRN
                    ...
                    End If
                      ...
                      If .TextMatrix(ln_cnt, 1) <> "" Then
                        ls_sql = "INSERT into IC_InventoryAdjDetail(Compcode,BranchCode, TransCode,customcode, ItemCode,StockInHand,StockONShelf, Quantity,InvType, ItemRate, Amount,AvgRate,Remarks)"
                        ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Trim(.TextMatrix(ln_cnt, 1)) & "','" & Trim(.TextMatrix(ln_cnt, 12)) & "'," & Val(0 & .TextMatrix(ln_cnt, 4)) & "," & Val(0 & .TextMatrix(ln_cnt, 5)) & "," & Val(0 & .TextMatrix(ln_cnt, 6)) & "," & ln_Adj & "," & Val(0 & .TextMatrix(ln_cnt, 8)) & "," & Val(0 & .TextMatrix(ln_cnt, 9)) & "," & Val(0 & .TextMatrix(ln_cnt, 10)) & " , '" & Trim(.TextMatrix(ln_cnt, 15)) & "' )"
                        gc_dbcon.Execute ls_sql
                     End If
                    Next
                 End With
...
Private Sub InitializeGrid()
   'Previous Configuration
    ...
    '    .Clear
    '    .Rows = 2
    '    .FormatString = "Sr# |<Custom Code|<Item Name|<UOM|<Stock |< Qty|<Tot QTY|<Adj Type|<Pur Rate|<Total|<Sale Rate|<Remarks|<Itemcode"
    '    .ColWidth(1) = 1500
    '    .ColWidth(2) = 3500
    '    .ColWidth(3) = 0
    '    .ColWidth(4) = 800
...
If Not Pr_LoadTrans.EOF Then
        With GrdGRN
            Do While Not Pr_LoadTrans.EOF
                ...
                .TextMatrix(.Row, 13) = Pr_LoadTrans("Quantity")
                ...
                .TextMatrix(.Row, 15) = Trim(Pr_LoadTrans("Remarks") & "")
                
                
              PR_UOM.Open "Select * From IC_ItemCategory Where CatCode='" & Trim(Pr_LoadTrans("CatCode") & "") & " '", gc_dbcon, adOpenStatic, adLockReadOnly
              If PR_UOM.RecordCount > 0 Then
                .TextMatrix(.Row, 14) = Trim(PR_UOM("Description") & "")
              End If
              
              PR_UOM.Close
                 PR_UOM.Open "Select * From IC_ItemClass Where DeptCode='" & Trim(Pr_LoadTrans("CatCode") & "") & "' and ClassCode='" & Trim(Pr_LoadTrans("ClassID") & "") & "'", gc_dbcon, adOpenStatic, adLockReadOnly
              If PR_UOM.RecordCount > 0 Then
                .TextMatrix(.Row, 16) = Trim(PR_UOM("Description") & "")
              End If
              PR_UOM.Close
                txtitemname = .TextMatrix(.Row, 2)
                txtitemcode.Text = .TextMatrix(.Row, 12)
                ...
                ls_sql = "INSERT into IC_InventoryAdjDetailLog(Compcode,BranchCode, TransCode,customcode, ItemCode, Stockinhand,stockonshelf,Quantity,invtype, ItemRate, Amount,AvgRate,Remarks,ComputerName,rowid,EMode)"
                ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Trim(.TextMatrix(.Row, 1)) & "','" & Trim(.TextMatrix(.Row, 12)) & "'," & Val(0 & .TextMatrix(.Row, 4)) & "," & Val(0 & .TextMatrix(.Row, 5)) & "," & Val(0 & .TextMatrix(.Row, 6)) & "," & Val(Pr_LoadTrans("Invtype")) & "," & Val(0 & .TextMatrix(.Row, 8)) & "," & Val(0 & .TextMatrix(.Row, 9)) & "," & Val(0 & .TextMatrix(.Row, 10)) & " , '" & Trim(.TextMatrix(.Row, 15)) & "','" & Gs_ComputerName & "'," & .Row & " ,'" & Mode & "')"
                gc_dbcon.Execute ls_sql
    ...
    If .Col = 1 Then
          ...
          If SearchInGrid(GrdGRN, .TextMatrix(.Row, 1)) Then
             .Row = TmpRow
                 ...
                 .TextMatrix(.Rows - 1, 1) = ""
                 .TextMatrix(.Row, 5) = 1
                 .TopRow = TmpRow 'To Move the Scrollbar
              Exit Sub
           Else
        ...
        If PR_IcItem.State = 1 Then PR_IcItem.Close
          ...
          Else
             ...
             .TextMatrix(.Row, 10) = PR_IcItem("Salecost")
             .TextMatrix(.Row, 9) = 0
             '.TextMatrix(.Row, 10) = 0
              txtitemname = .TextMatrix(.Row, 2)
             '.TextMatrix(.Row, 15) = TxtRemarks.Text
             .Col = 5
             .CellBackColor = vbHighlight
             .TextMatrix(.Row, 5) = 1
              ...
              PR_UOM.Close
                ...
                PR_UOM.Open "Select * From IC_ItemCategory Where CatCode='" & Trim(PR_IcItem("CatCode") & "") & " '", gc_dbcon, adOpenStatic, adLockReadOnly
              If PR_UOM.RecordCount > 0 Then
                .TextMatrix(.Row, 14) = Trim(PR_UOM("Description") & "")
              End If
              
              PR_UOM.Close
                 PR_UOM.Open "Select * From IC_ItemClass Where DeptCode='" & Trim(PR_IcItem("CatCode") & "") & "' and ClassCode='" & Trim(PR_IcItem("ClassID") & "") & "'", gc_dbcon, adOpenStatic, adLockReadOnly
              If PR_UOM.RecordCount > 0 Then
                .TextMatrix(.Row, 16) = Trim(PR_UOM("Description") & "")
              End If
              PR_UOM.Close
                ...
                txtCat.Text = .TextMatrix(.Row, 14)
                txtSubCat.Text = .TextMatrix(.Row, 16)
               .TextMatrix(.Row, 15) = .TextMatrix(.Row, 14)
               .TextMatrix(.Row, 7) = "Inv In"
       ...
       ElseIf .Col = 5 Then
           ...
           End If
            If Val(.TextMatrix(.Row, 4)) < 0 Then
               .TextMatrix(.Row, 4) = Val(.TextMatrix(.Row, 4)) * -1
               .TextMatrix(.Row, 6) = Val(.TextMatrix(.Row, 13)) + Val(.TextMatrix(.Row, 5)) + Val(.TextMatrix(.Row, 4))
            Else
             .TextMatrix(.Row, 6) = Val(.TextMatrix(.Row, 13)) + Val(.TextMatrix(.Row, 5)) + Val(.TextMatrix(.Row, 4))
             .TextMatrix(.Row, 13) = Val(.TextMatrix(.Row, 6))
          ...
          Call TotalAmount
           ...
           ls_sql = "INSERT into IC_InventoryAdjDetailLog(Compcode,BranchCode, TransCode,customcode, ItemCode,stockinhand,stockonshelf,invtype, Quantity, ItemRate, Amount,AvgRate,Remarks,ComputerName,rowid,EMode)"
           ls_sql = ls_sql & " VALUES ('" & Gs_compcode & "','" & Gs_BranchCode & "','" & Trim(txttransno) & "','" & Trim(.TextMatrix(.Row, 1)) & "','" & Trim(.TextMatrix(.Row, 12)) & "'," & Val(0 & .TextMatrix(.Row, 4)) & "," & Val(0 & .TextMatrix(.Row, 5)) & "," & ln_Adj & "," & Val(0 & .TextMatrix(.Row, 6)) & "," & Val(0 & .TextMatrix(.Row, 8)) & "," & Val(0 & .TextMatrix(.Row, 9)) & "," & Val(0 & .TextMatrix(.Row, 10)) & " , '" & Trim(.TextMatrix(.Row, 15)) & "','" & Gs_ComputerName & "'," & .Row & ",'" & Mode & "' )"
           gc_dbcon.Execute ls_sql
...
If Val(.TextMatrix(.Row, 6)) > 0 Then
          ...
          '  .TextMatrix(.Row, 6) = Val(.TextMatrix(.Row, 5)) - Val(.TextMatrix(.Row, 4))
           .TextMatrix(.Row, 7) = "Inv In"
            ln_Adj = 0
           ' End If
        ' .TextMatrix(.Row, 6) = Val(.TextMatrix(.Row, 13)) + Val(.TextMatrix(.Row, 5))
